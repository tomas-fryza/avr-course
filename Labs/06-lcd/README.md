...
Extra. From the LCD position "c", displays running text, ie text that moves characters to the left four times per second. Hint: Use Timer/Counter1 with an 262ms overflow and move the auxiliary variable along the defined string, such as `uint8_t running_text[] = "   I like Digital electronics!\n";`.
